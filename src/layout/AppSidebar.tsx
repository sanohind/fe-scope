...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "WHRM03", path: "/inventory/whrm03" },
      { name: "WHMT01", path: "/inventory/whmt01" },
      { name: "Overview Finish Good", path: "/inventory-fg" },
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "WHRM03", path: "/warehouse/whrm03" },
      { name: "WHMT01", path: "/warehouse/whmt01" },
      { name: "Overview Finish Good", path: "/warehouse-fg" },
