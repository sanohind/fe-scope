...
import { useSalesFilters, SalesDateMode } from "../../../context/SalesFilterContext";

interface SalesFilterHeaderProps {
  title?: string;
}

const MODE_OPTIONS: { value: SalesDateMode; label: string }[] = [
  { value: "daily", label: "Daily" },
  { value: "monthly", label: "Monthly" },
  { value: "yearly", label: "Yearly" },
];

const SalesFilterHeader: React.FC<SalesFilterHeaderProps> = ({ title = "Global Filters" }) => {
  const { mode, setMode, months, years, rangeSummary, rangeDescription, resetFilters, daily, monthly, yearly } = useSalesFilters();
...
export default SalesFilterHeader;
