...
const TopCriticalItems: React.FC = () => {
    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/5 flex flex-col h-full">
      ...
      <div className="flex-1 overflow-hidden">
        <div className="max-w-full overflow-x-auto h-full">
          <div className="overflow-y-auto h-[500px]" style={{ 
            scrollbarWidth: 'thin',
            ...
            <table className="w-full min-w-[1000px]">
              <thead className="sticky top-0 bg-white dark:bg-gray-900 z-10">
                <tr className="border-b border-gray-200 dark:border-gray-800">
                  <th className="px-4 py-3 text-left text-sm font-medium text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-900">
                    Warehouse
                  </th>
                  <th className="px-4 py-3 text-left text-sm font-medium text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-900">
                    Part No
                  ...
                  <th className="px-4 py-3 text-right text-sm font-medium text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-900">
                    Onhand
                  </th>
                  <th className="px-4 py-3 text-right text-sm font-medium text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-900">
                    Safety Stock
              ...
              <tbody>
                {data.length === 0 ? (
                  ...
                  data.map((item, index) => (
                    <tr
                      key={`${item.warehouse}-${item.partno}-${index}`}
