...
import { useAsakaiFilters, AsakaiDateMode } from "../../../context/AsakaiFilterContext";

interface AsakaiFilterHeaderProps {
  title?: string;
}

const MODE_OPTIONS: { value: AsakaiDateMode; label: string }[] = [
  { value: "daily", label: "Daily" },
  { value: "monthly", label: "Monthly" },
  { value: "yearly", label: "Yearly" },
];

const AsakaiFilterHeader: React.FC<AsakaiFilterHeaderProps> = ({ title = "Global Filters" }) => {
  const { mode, setMode, months, years, rangeSummary, rangeDescription, resetFilters, daily, monthly, yearly } = useAsakaiFilters();
...
export default AsakaiFilterHeader;
