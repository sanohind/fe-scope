...
// Helper: Fetch with Authorization header from localStorage token
...
export const inventoryApi = {
  ...
  getStockDistributionByProductType: async () => {
    const response = await authFetch(`${BASE_URL}/api/dashboard/inventory/stock-distribution-by-product-type`);
  ...
  getAllData: async () => {
    const response = await authFetch(`${BASE_URL}/api/dashboard/inventory/all-data`);
...
export const warehouseApi = {
  ...
  getTopItemsMoved: async (limit: number = 20) => {
    const response = await authFetch(`${BASE_URL}/api/dashboard/warehouse/top-items-moved?limit=${limit}`);
    if (!response.ok) {
  ...
  getOrderTimelineFilters: async () => {
    const response = await authFetch(`${BASE_URL}/api/dashboard/warehouse/order-timeline/filters`);
  ...
  getOrderTimelineDetail: async (orderNo: string) => {
    const response = await authFetch(`${BASE_URL}/api/dashboard/warehouse/order-timeline/${orderNo}`);
  ...
  // Get all dashboard data
  getAllData: async () => {
    const response = await authFetch(`${BASE_URL}/api/dashboard/warehouse/all-data`);
...
export const salesApi = {
  ...
  // Get all dashboard data
  getAllData: async () => {
    const response = await authFetch(`${BASE_URL}/api/dashboard/sales/all-data`);
...
export const productionApi = {
  ...
  getProductionByWarehouse: async () => {
    const response = await authFetch(`${BASE_URL}/api/dashboard/production/by-warehouse`);
  ...
  getDailyProductionQtyOdoo: async (params?: { period?: "daily" | "monthly" | "yearly"; date_from?: string; date_to?: string }) => {
    const cleaned = cleanParams(params);
    const queryParams = new URLSearchParams(cleaned as any).toString();
    const url = `${BASE_URL}/api/dashboard/production/daily-production-qty-odoo${queryParams ? `?${queryParams}` : ""}`;
    const response = await authFetch(url);
    if (!response.ok) throw new Error("Failed to fetch daily production qty odoo");
    return response.json();
  },
  ...
  // Get all dashboard data
  getAllData: async () => {
    const response = await authFetch(`${BASE_URL}/api/dashboard/production/all-data`);
...
export const procurementApi = {
  ...
  getProcurementKpi: async () => {
    const response = await authFetch(`${BASE_URL}/api/dashboard/procurement/kpi`);
  ...
  getReceiptPerformance: async () => {
    const response = await authFetch(`${BASE_URL}/api/dashboard/procurement/receipt-performance`);
  ...
  getTopSuppliersByValue: async (limit: number = 20) => {
    const response = await authFetch(`${BASE_URL}/api/dashboard/procurement/top-suppliers-by-value?limit=${limit}`);
  ...
  getSupplierDeliveryPerformance: async () => {
    const response = await authFetch(`${BASE_URL}/api/dashboard/procurement/supplier-delivery-performance`);
  ...
  getReceiptByItemGroup: async () => {
    const response = await authFetch(`${BASE_URL}/api/dashboard/procurement/receipt-by-item-group`);
  ...
  getPoVsInvoiceStatus: async () => {
    const response = await authFetch(`${BASE_URL}/api/dashboard/procurement/po-vs-invoice-status`);
  ...
  getReceiptApprovalRateBySupplier: async (limit: number = 20) => {
    const response = await authFetch(`${BASE_URL}/api/dashboard/procurement/receipt-approval-rate-by-supplier?limit=${limit}`);
  ...
  // Get all dashboard data
  getAllData: async () => {
    const response = await authFetch(`${BASE_URL}/api/dashboard/procurement/all-data`);
...
export const hrApi = {
  ...
  getActiveEmployeesCount: async () => {
    const response = await authFetch(`${BASE_URL}/api/dashboard/hr/active-employees-count`);
  ...
  getEmploymentStatusComparison: async () => {
    const response = await authFetch(`${BASE_URL}/api/dashboard/hr/employment-status-comparison`);
  ...
  // Get all dashboard data
  getAllData: async () => {
    const response = await authFetch(`${BASE_URL}/api/dashboard/hr/all-data`);
